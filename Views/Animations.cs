...
namespace BookShop.Views
{
	public class Animations
	{
		...
		{
			ColorAnimation animation = new(Color.FromRgb(255, 136, 125), Color.FromRgb(181, 0, 71),
		...
		{
			ColorAnimation animation = new(Color.FromRgb(181, 0, 71), Color.FromRgb(255, 136, 125),
				new Duration(TimeSpan.FromSeconds(0.5)));
			button.Background.BeginAnimation(SolidColorBrush.ColorProperty, animation);
		}
		...
		{
			ColorAnimation animation = new(Color.FromRgb(255, 255, 225), Color.FromRgb(241, 196, 15),
				new Duration(TimeSpan.FromSeconds(0.5)));
			button.Background.BeginAnimation(SolidColorBrush.ColorProperty, animation);
		}
		...
		{
			ColorAnimation animation = new(Color.FromRgb(241, 196, 15), Color.FromRgb(255, 255, 225),
				new Duration(TimeSpan.FromSeconds(0.5)));
			button.Background.BeginAnimation(SolidColorBrush.ColorProperty, animation);
		}
		...
		{
			ColorAnimation animation = new(Color.FromRgb(252, 255, 252), Color.FromRgb(229, 255, 231),
				new Duration(TimeSpan.FromSeconds(0.5)));
			button.Background.BeginAnimation(SolidColorBrush.ColorProperty, animation);
		}
		...
		{
			ColorAnimation animation = new(Color.FromRgb(229, 255, 231), Color.FromRgb(252, 255, 252),
				new Duration(TimeSpan.FromSeconds(0.5)));
			button.Background.BeginAnimation(SolidColorBrush.ColorProperty, animation);
		}
